...
/**
 * IMPORTANT: TutorCard, EmptyTutorsState, FilterSection, and FilterPanelContent
 * all live OUTSIDE the StudentTutors component now. Previously they were declared
 * inside StudentTutors's function body, which meant React saw a brand-new
 * component "type" on every re-render (every keystroke). That forced React to
 * unmount and remount the whole subtree — including your <input> elements —
 * which is why focus was lost and you had to click back in after every
 * character. Keeping them at module scope means React reuses the same DOM
 * nodes across renders and inputs stay focused while typing.
 */
...
const FilterPanelContent = ({
    ...
    <>
        <FilterSection title="Subject" name="subject" expandedFilters={expandedFilters} toggleFilter={toggleFilter}>
        ...
        <FilterSection title="Location" name="location" expandedFilters={expandedFilters} toggleFilter={toggleFilter}>
            <div className="relative">
        ...
        <FilterSection title="Language" name="language" expandedFilters={expandedFilters} toggleFilter={toggleFilter}>
            <select
        ...
        <FilterSection title="Price Range" name="price" expandedFilters={expandedFilters} toggleFilter={toggleFilter}>
        ...
        <FilterSection title="Session Type" name="sessionType" expandedFilters={expandedFilters} toggleFilter={toggleFilter}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-sm">
                        ...
                        <div className="md:col-span-3">
                            {!isTutorLoading && filteredTutors.length === 0 ? (
                                <EmptyTutorsState activeFilterCount={activeFilterCount} resetFilters={resetFilters} />
                            ) : (
