...
const StudentMessages = () => {
    ...
    // TODO: confirm useGetChats()'s actual return shape — assumed to mirror
    // the useGetSingleTutor pattern already used elsewhere (`{ data key, isLoading }`).
    // Guarded with Array.isArray because react-query hooks resolve to
    // undefined on the first render (and the "data" wrapper shape varies),
    // which is what threw "chats.find is not a function" before.
    ...
    // cleanup so we never leave a stale connection open while the user
