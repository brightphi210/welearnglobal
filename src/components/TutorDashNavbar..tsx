                                ...
                                <>
                                    {user?.profile_image ? (
                                        <button
                                            ...
                                            className="w-9 h-9 rounded-full overflow-hidden border border-gray-200 hover:ring-2 hover:ring-emerald-200 transition-all"
                                        >
                                            <img
                                        ...
                                        <button
                                            onClick={() => setProfileMenuOpen((prev) => !prev)}
                                            className="w-9 h-9 rounded-full bg-emerald-900 flex items-center justify-center text-white font-semibold text-sm hover:shadow-md hover:ring-2 hover:ring-emerald-200 transition-all"
                                        >
                                            {getInitials()}
                                        </button>
                                    )}
