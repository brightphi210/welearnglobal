            ...
            <div className="w-full max-w-lg">
                ...
                <div className="bg-white rounded-2xl border border-gray-100 shadow-xl shadow-gray-200/50 overflow-hidden">
                    ...
                    <div className="px-8 pt-10 pb-6 text-center">
                        ...
                        <p className="text-sm text-gray-500">Join our community of learners today.</p>
                    </div>
                    ...
                    <div className="px-8 pb-8 space-y-5">
                        ...
                        <div className="flex rounded-xl bg-gray-100 p-1">
                            <button
                                ...
                                className={`flex-1 flex items-center justify-center gap-2 py-2.5 rounded-lg text-sm font-semibold transition-all cursor-pointer border-none ${role === "student"
                                    ? "bg-gradient-to-r from-emerald-400 to-emerald-600 text-white shadow-md shadow-emerald-200"
                        ...
                        <label className="flex items-start gap-2.5 cursor-pointer group">
                            <div
                                ...
                                className={`w-4 h-4 rounded border-[1.5px] flex items-center justify-center transition-all cursor-pointer shrink-0 mt-0.5 ${agreed ? "bg-emerald-500 border-emerald-500" : "border-gray-300 bg-white"
                                    }`}
                            >
                                {agreed && (
                        ...
                        {/* Submit */}
                        <button className="w-full flex items-center justify-center gap-2 py-3.5 rounded-xl bg-gradient-to-r from-emerald-400 to-emerald-600 text-white font-bold text-sm hover:opacity-90 hover:-translate-y-px transition-all border-none cursor-pointer shadow-md shadow-emerald-200">
                    ...
                    <div className="px-8 py-5 border-t border-gray-100 text-center">
                        <p className="text-sm text-gray-500">
                            ...
                            <a href="/login" className="text-emerald-500 font-semibold hover:text-emerald-600 no-underline transition-colors">
                                Log in
                            </a>
                        </p>
                    </div>
