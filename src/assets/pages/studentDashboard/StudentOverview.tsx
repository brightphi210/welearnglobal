                ...
                <div className="px-4 sm:px-6 max-w-6xl m-auto lg:px-8 py-8">
                    ...
                    <div className="bg-green-900 rounded-2xl p-6 sm:p-8 text-white mb-8 shadow-lg shadow-green-200/60">
                        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
                            ...
                            <div className="flex gap-3 w-full sm:w-auto">
                                <button className="flex-1 text-sm sm:flex-none px-5 py-2.5 bg-white text-green-600 rounded-sm font-semibold transition-all">
                                    Join Session
                                </button>
                    ...
                    <div className="mb-12">
                        ...
                        <div className="grid grid-cols-4 lg:grid-cols-6 gap-1">
                            {categories.map(({ id, name, icon: Icon }) => (
                                <button
                                    key={id}
                                    className={`flex flex-col items-center gap-3 p-6 bg-white rounded-md border border-gray-100 hover:border-green-200 hover:shadow-lg transition-all group`}
                                >
                    ...
                    <div className="mb-12">
                        <div className="flex items-center justify-between mb-6">
                            ...
                            <a href="/tutors" className="text-green-600 font-semibold text-sm flex items-center gap-2 hover:text-green-700">
                                All tutors
