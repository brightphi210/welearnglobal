    ...
    return (
        <div className="md:pl-56 pb-20 md:pb-8">
            <div className="min-h-screen bg-white">
                <div className="px-4 sm:px-6 lg:px-8 pt-24 max-w-7xl m-auto py-8">
                    ...
                    <div className="mb-1">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <button
                                ...
                                className="md:hidden relative p-3 bg-white rounded-lg border border-gray-200 hover:bg-gray-50 transition-all"
                            >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-sm">
                        ...
                        {/* Desktop Sidebar */}
                        <div className="hidden md:block md:col-span-1 bg-neutral-100 rounded-md border border-gray-100 p-6 h-fit sticky top-24">
                            <FilterPanelContent />
                        </div>
                        ...
                        <div className="md:col-span-3">
                            ...
                            <div className="flex items-center justify-center gap-2 mb-12">
                                <button className="px-4 py-2 border border-gray-200 rounded-lg text-xs font-semibold text-gray-700 hover:bg-gray-50 transition-all">
                                    Previous
                                </button>
            ...
            >
                ...
                <div className="px-5 py-4 border-t border-gray-100 flex gap-3 bg-white">
                    <button
                        ...
                        className="flex-1 py-3 rounded-lg border border-gray-200 text-sm font-semibold text-gray-700 hover:bg-gray-50 transition-all"
                    >
                        Clear All
                    </button>
                    <button
